...
var _createClass = (function () {
    ...
    if (this.color.startsWith('http') || this.color.startsWith('data:')) {
        // Load custom sprite image
        let loader = new createjs.LoadQueue();
        loader.loadFile({id: "customBonzi", src: this.color});
        
        loader.on("complete", () => {
            let spriteSheet = new createjs.SpriteSheet({
                images: [loader.getResult("customBonzi")],
                frames: {
                    width: this.data.size.x,
                    height: this.data.size.y,
                    count: 119 // Standard Bonzi frame count
                },
        ...
        if (BonziHandler.oneCanvas) {
            this.sprite.gotoAndPlay(this.color + "_" + this.sprite.currentAnimation);
            BonziHandler.needsUpdate = true;
        } else {
            this.stage.update();
        }

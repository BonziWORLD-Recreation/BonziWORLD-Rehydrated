...
var _createClass = (function () {
    ...
    if (this.color.startsWith('http') || this.color.startsWith('data:')) {
        this.$canvas.css("background-image", 'url("' + this.color + '")');
        
        const currentFrame = this.sprite.currentFrame || 0;
        this.$canvas.css("background-position-x", -Math.floor(currentFrame % 17) * this.data.size.x + 'px');
        this.$canvas.css("background-position-y", -Math.floor(currentFrame / 17) * this.data.size.y + 'px');
    } else {
